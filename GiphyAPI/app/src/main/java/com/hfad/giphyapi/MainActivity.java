...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proggy = (ProgressBar) findViewById(R.id.progress);
    ...
    private class ImageProcessingAsyncTask extends AsyncTask<String,Integer,Bitmap> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            proggy.setProgress(values[0]);
        }

        @Override
        protected void onPostExecute(Bitmap bitmap) {
            immyStill.setImageBitmap(bitmap);
            proggy.setVisibility(View.INVISIBLE);
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            proggy.setVisibility(View.VISIBLE);
            proggy.setProgress(0);
        }
        ...
        private Bitmap invertImageColors(Bitmap bitmap){
            ...
            for (int i = 0; i < mutableBitmap.getWidth(); i++) {
                ...
                proggy.setProgress(progressVal);
            }
